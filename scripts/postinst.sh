...
python3 -m pip install https://github.com/CleepDevice/cleep-libs-prebuild/blob/main/numpy/bullseye/numpy-1.26.4-cp39-cp39-linux_armv7l.whl
python3 -m pip install https://github.com/CleepDevice/cleep-libs-prebuild/blob/main/scipy/bullseye/scipy-1.13.0-cp39-cp39-linux_armv7l.whl
